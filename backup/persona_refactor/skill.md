...
## Persona Elements (Data-Driven)

1.  **Name:** Tên đại diện cho Persona.
2.  **Demographics:** Thông tin nhân khẩu học cơ bản (tuổi, nghề nghiệp, vị trí, v.v.).
3.  **Goals:** Mục tiêu chính và phụ mà Persona muốn đạt được.
4.  **Tasks:** Các công việc hoặc nhiệm vụ mà Persona thực hiện liên quan đến sản phẩm/dịch vụ.
5.  **Pains:** Những khó khăn, vấn đề, hoặc điểm gây khó chịu mà Persona gặp phải.
6.  **Wishes:** Những mong muốn, kỳ vọng của Persona đối với sản phẩm/dịch vụ.
7.  **Touchpoints:** Các điểm tiếp xúc hoặc tương tác của Persona với sản phẩm/dịch vụ trong suốt hành trình của họ.
8.  **Tags:** Các từ khóa hoặc nhãn mô tả Persona (ví dụ: sở thích, kỹ năng, tính cách).
9.  **Quotes:** Những câu trích dẫn trực tiếp thể hiện quan điểm, cảm xúc hoặc suy nghĩ của Persona.
