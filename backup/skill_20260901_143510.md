...
## 9 Yếu tố Persona chuẩn (Data-Driven)

Để đảm bảo Persona phản ánh chân thực người dùng và cung cấp đủ thông tin cho thiết kế, cần bao gồm 9 yếu tố sau:

1.  **Tên & Ảnh đại diện (Name & Photo):**
    *   Ý nghĩa: Tạo sự gần gũi, dễ hình dung về người dùng. Ảnh đại diện giúp cá nhân hóa Persona.
    *   Dữ liệu: Chọn tên gợi nhớ, phù hợp vai trò. Ảnh có thể là ảnh minh họa (stock photo) hoặc ảnh do người dùng cung cấp.
2.  **Nhân khẩu học (Demographics):**
    *   Ý nghĩa: Mô tả các đặc điểm cơ bản về người dùng.
    *   Dữ liệu: Tuổi, nghề nghiệp, trình độ học vấn, vị trí địa lý, tình trạng hôn nhân, thu nhập (nếu liên quan).
3.  **Hồ sơ / Vai trò (Background / Role):**
    *   Ý nghĩa: Bối cảnh chi tiết về công việc, cuộc sống, kinh nghiệm liên quan đến sản phẩm/dịch vụ.
    *   Dữ liệu: Công việc hiện tại, vai trò trong nhóm/tổ chức, kinh nghiệm làm việc trước đây, trình độ chuyên môn.
4.  **Mục tiêu (Goals & Motivations):**
    *   Ý nghĩa: Người dùng muốn đạt được điều gì khi sử dụng sản phẩm/dịch vụ? Điều gì thúc đẩy họ?
    *   Dữ liệu: Mục tiêu chính (primary goals) và mục tiêu phụ (secondary goals) liên quan đến ngữ cảnh sử dụng.
5.  **Nỗi đau / Khó khăn (Pain Points & Frustrations):**
    *   Ý nghĩa: Những vấn đề, rào cản, hoặc sự khó chịu mà người dùng gặp phải trong quá trình thực hiện mục tiêu.
    *   Dữ liệu: Các vấn đề gặp phải, những gì khiến họ bực bội hoặc thất vọng.
6.  **Hành vi / Tình huống sử dụng (Behaviors / Use Cases):**
    *   Ý nghĩa: Cách người dùng tương tác với sản phẩm/dịch vụ hoặc giải quyết vấn đề trong thực tế.
    *   Dữ liệu: Quy trình làm việc hiện tại, các công cụ đang sử dụng, thói quen sử dụng công nghệ, cách họ tiếp cận vấn đề.
7.  **Trích dẫn tiêu biểu (Quotes):**
    *   Ý nghĩa: Một câu nói ngắn gọn, chân thực thể hiện suy nghĩ, cảm xúc hoặc thái độ của người dùng.
    *   Dữ liệu: Trích dẫn trực tiếp từ phỏng vấn hoặc khảo sát, thể hiện rõ quan điểm của họ.
8.  **Mức độ am hiểu công nghệ (Tech Savviness):**
    *   Ý nghĩa: Đánh giá sự quen thuộc và thoải mái của người dùng với công nghệ, thiết bị, phần mềm.
    *   Dữ liệu: Mức độ sử dụng thiết bị (PC, mobile), các loại phần mềm quen thuộc, khả năng học hỏi công nghệ mới.
9.  **Thái độ / Đánh giá giải pháp (Attitude / Solution Feedback):**
    *   Ý nghĩa: Quan điểm của người dùng về giải pháp đề xuất, những kỳ vọng và lo ngại của họ.
    *   Dữ liệu: Mức độ quan tâm, đánh giá các tính năng cụ thể, rào cản khi áp dụng giải pháp mới.
